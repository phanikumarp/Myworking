...
import com.simplejmx.common.JmxResource;
import com.simplejmx.common.JmxResourceInfo;
import com.simplejmx.common.JmxSelfNaming;
import com.simplejmx.common.ObjectNameUtil;
...
public class JmxServer {
	...
	public synchronized void register(Object obj, ObjectName objectName, String description,
		...
		ReflectionMbean mbean;
		try {
			mbean =	new ReflectionMbean(obj, description, attributeFieldInfos, attributeMethodInfos, operationInfos,false);
		} catch (Exception e) {
			throw createJmException("Could not build MBean object for: " + obj, e);
		}
		doRegister(objectName, mbean);
